...
const routes = [
  ...
  },
  {
    path: "/sach/:id/edit",
    name: "sach-edit",
    component: () => import("@/views/SuaSach.vue"),
    meta: { requiresAuth: true, role: ["admin", "nhanvien"] },
    props: true,
  },
  {
  ...
  {
    path: "/admin/docgia/add",
    name: "AdminThemDocGia",
    component: () => import("@/views/admin/ThemDocGia.vue"),
    meta: { requiresAuth: true, role: ["admin", "nhanvien"] },
  },
  {
    path: "/admin/docgia/edit/:id",
    name: "AdminSuaDocGia",
    component: () => import("@/views/admin/SuaDocGia.vue"),
    meta: { requiresAuth: true, role: ["admin", "nhanvien"] },
    props: true,
  },
  {
